...
/**industry detail page **/
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                mDatabase.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        ref2.child(id).child("response").setValue(currentuser);
                    }
...

                {
                    ...
                    Toast.makeText(PostDetailActivity.this, l.get(), Toast.LENGTH_SHORT).show();
       ...
       transport1=findViewById(R.id.indquant2);

        final DatabaseReference mDatabase1 = FirebaseDatabase.getInstance().getReference("Industry");

        mDatabase1.addValueEventListener(new ValueEventListener() {
            String name,crop,description,emailt,price,quantity,tran12;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
              ...
              //  mDatabase.removeEventListener(ValueEventListener);
               ...
               //emailt=dataSnapshot.child(str).child("email").getValue().toString();
                ...
                tran12=dataSnapshot.child(str).child("transport").getValue().toString();
       ...
       // databaseReference.removeEventListener(valueEventListener);
        Button t1;
        t1=findViewById(R.id.transport);
        t1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                    Intent i=new Intent(PostDetailActivity.this,payment_trans.class);
                    startActivity(i);
            }
        });
